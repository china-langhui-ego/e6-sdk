...
typedef enum XrResult {
    ...
    XR_ERROR_MARKER_TRACKING_MODE_INVALID_QCOMX = -1000312000,
    XR_ERROR_MARKER_TYPE_INVALID_QCOMX = -1000312001,
    XR_ERROR_MARKER_SIZE_UNAVAILABLE_QCOMX = -1000312002,
    XR_ERROR_QR_CODE_DATA_UNAVAILABLE_QCOMX = -1000312003,
...
typedef enum XrStructureType {
    ...
    XR_TYPE_SYSTEM_IMAGE_TRACKING_PROPERTIES_QCOM = 1000303000,
    XR_TYPE_IMAGE_TRACKER_DATA_SET_COLLECTION_QCOM = 1000303001,
    XR_TYPE_IMAGE_TRACKER_HEIGHT_SET_COLLECTION_QCOM = 1000303002,
    ...
    XR_TYPE_IMAGE_TARGET_LOCATION_QCOM = 1000303007,
    XR_TYPE_IMAGE_TARGET_VELOCITY_QCOM = 1000303008,
    XR_TYPE_IMAGE_TARGET_LOCATIONS_QCOM = 1000303009,
    XR_TYPE_IMAGE_TARGET_VELOCITIES_QCOM = 1000303010,
    XR_TYPE_SYSTEM_OBJECT_TRACKING_PROPERTIES_QCOM = 1000304000,
    XR_TYPE_OBJECT_TRACKER_DATA_SET_CREATE_INFO_QCOM = 1000304001,
    XR_TYPE_OBJECT_TRACKER_CREATE_INFO_QCOM = 1000304002,
    XR_TYPE_OBJECT_TARGETS_TRACKING_MODE_INFO_QCOM = 1000304003,
    XR_TYPE_OBJECT_TARGETS_LOCATE_INFO_QCOM = 1000304004,
    XR_TYPE_OBJECT_TARGET_LOCATIONS_QCOM = 1000304005,
    XR_TYPE_OBJECT_TARGET_VELOCITIES_QCOM = 1000304006,
    XR_TYPE_OBJECT_TARGET_BOX_BOUNDS_QCOM = 1000304007,
    XR_TYPE_SYSTEM_PLANE_DETECTION_PROPERTIES_QCOM = 1000305000,
    ...
    XR_TYPE_PLANE_LOCATION_QCOM = 1000305004,
    XR_TYPE_PLANE_EXTENT_QCOM = 1000305005,
    XR_TYPE_EXTENT2_DF_QCOM = 1000305006,
...
typedef enum XrObjectType {
    ...
    XR_OBJECT_TYPE_IMAGE_TRACKER_QCOM = 1000303000,
    XR_OBJECT_TYPE_IMAGE_TARGET_QCOM = 1000303001,
    XR_OBJECT_TYPE_OBJECT_TRACKER_QCOM = 1000304000,
    XR_OBJECT_TYPE_OBJECT_TRACKER_DATA_SET_QCOM = 1000304001,
    XR_OBJECT_TYPE_OBJECT_TARGET_QCOM = 1000304002,
    XR_OBJECT_TYPE_PLANE_DETECTION_QCOM = 1000305000,
    XR_OBJECT_TYPE_RAY_CAST_QCOM = 1000307000,
    XR_OBJECT_TYPE_CAMERA_QCOMX = 1000311000,
    XR_OBJECT_TYPE_CAMERA_FRAME_QCOMX = 1000311001,
    XR_OBJECT_TYPE_MARKER_TRACKER_QCOMX = 1000312000,
    XR_OBJECT_TYPE_MARKER_QCOMX = 1000312001,
    XR_OBJECT_TYPE_MARKER_UPDATE_QCOMX = 1000312002,
