...
#define XR_LIST_ENUM_XrResult(_) \
    ...
    _(XR_ERROR_OBJECT_TRACKER_NOT_INITIALIZED_QCOM, -1000304000) \
    _(XR_ERROR_OBJECT_TRACKER_DATA_SET_IN_USE_QCOM, -1000304001) \
    _(XR_ERROR_PLANE_DETECTION_NOT_INITIALIZED_QCOM, -1000305000) \
    _(XR_ERROR_RAY_CAST_TARGET_TYPE_INVALID_QCOM, -1000307000) \
    _(XR_ERROR_RAY_MAX_DISTANCE_INVALID_QCOM, -1000307001) \
    _(XR_ERROR_RAY_CAST_NOT_FINISHED_QCOM, -1000307002) \
...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_SYSTEM_IMAGE_TRACKING_PROPERTIES_QCOM, 1000303000) \
    _(XR_TYPE_IMAGE_TRACKER_DATA_SET_COLLECTION_QCOM, 1000303001) \
    _(XR_TYPE_IMAGE_TRACKER_HEIGHT_SET_COLLECTION_QCOM, 1000303002) \
    _(XR_TYPE_IMAGE_TRACKER_DATA_SET_IMAGE_QCOM, 1000303003) \
    _(XR_TYPE_IMAGE_TRACKER_CREATE_INFO_QCOM, 1000303004) \
    _(XR_TYPE_IMAGE_TARGETS_LOCATE_INFO_QCOM, 1000303005) \
    _(XR_TYPE_IMAGE_TARGET_LOCATION_QCOM, 1000303006) \
    _(XR_TYPE_IMAGE_TARGET_VELOCITY_QCOM, 1000303007) \
    _(XR_TYPE_IMAGE_TARGET_LOCATIONS_QCOM, 1000303008) \
    _(XR_TYPE_IMAGE_TARGET_VELOCITIES_QCOM, 1000303009) \
    _(XR_TYPE_SYSTEM_OBJECT_TRACKING_PROPERTIES_QCOM, 1000304000) \
    _(XR_TYPE_OBJECT_TRACKER_DATA_SET_CREATE_INFO_QCOM, 1000304001) \
    _(XR_TYPE_OBJECT_TRACKER_CREATE_INFO_QCOM, 1000304002) \
    _(XR_TYPE_OBJECT_TARGETS_LOCATE_INFO_QCOM, 1000304003) \
    _(XR_TYPE_OBJECT_TARGET_LOCATIONS_QCOM, 1000304004) \
    _(XR_TYPE_OBJECT_TARGET_VELOCITIES_QCOM, 1000304005) \
    _(XR_TYPE_OBJECT_TARGET_BOX_BOUNDS_QCOM, 1000304006) \
    _(XR_TYPE_SYSTEM_PLANE_DETECTION_PROPERTIES_QCOM, 1000305000) \
    _(XR_TYPE_PLANE_DETECTION_CREATE_INFO_QCOM, 1000305001) \
    _(XR_TYPE_PLANES_LOCATE_INFO_QCOM, 1000305002) \
    _(XR_TYPE_PLANE_LOCATIONS_QCOM, 1000305003) \
    _(XR_TYPE_PLANE_LOCATION_QCOM, 1000305004) \
    _(XR_TYPE_PLANE_EXTENT_QCOM, 1000305005) \
    _(XR_TYPE_EXTENT2_DF_QCOM, 1000305006) \
    _(XR_TYPE_PLANE_CONVEX_HULL_BUFFER_INFO_QCOM, 1000305007) \
    _(XR_TYPE_PLANE_CONVEX_HULL_VERTEX_BUFFER_QCOM, 1000305008) \
    _(XR_TYPE_RAY_CAST_CREATE_INFO_QCOM, 1000307000) \
    _(XR_TYPE_RAY_COLLISIONS_GET_INFO_QCOM, 1000307001) \
    _(XR_TYPE_RAY_COLLISIONS_QCOM, 1000307002) \
    _(XR_TYPE_RAY_COLLISION_QCOM, 1000307003) \
    _(XR_TYPE_COMPONENT_VERSION_QCOM, 1000308000) \
...
#define XR_LIST_ENUM_XrObjectType(_) \
    ...
    _(XR_OBJECT_TYPE_IMAGE_TRACKER_QCOM, 1000303000) \
    _(XR_OBJECT_TYPE_IMAGE_TARGET_QCOM, 1000303001) \
    _(XR_OBJECT_TYPE_OBJECT_TRACKER_QCOM, 1000304000) \
    _(XR_OBJECT_TYPE_OBJECT_TRACKER_DATA_SET_QCOM, 1000304001) \
    _(XR_OBJECT_TYPE_OBJECT_TARGET_QCOM, 1000304002) \
    _(XR_OBJECT_TYPE_PLANE_DETECTION_QCOM, 1000305000) \
    _(XR_OBJECT_TYPE_RAY_CAST_QCOM, 1000307000) \
...
#define XR_LIST_ENUM_XrObjectTrackerStateQCOM(_) \
    _(XR_OBJECT_TRACKER_STATE_NONE_QCOM, 0) \
    _(XR_OBJECT_TRACKER_STATE_INITIALIZING_QCOM, 1) \
    _(XR_OBJECT_TRACKER_STATE_TRACKING_QCOM, 2) \
    _(XR_OBJECT_TRACKER_STATE_ERROR_QCOM, 3) \
    _(XR_OBJECT_TRACKER_STATE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrObjectTrackerDataSetTypeQCOM(_) \
    _(XR_OBJECT_TRACKER_DATA_SET_TYPE_COLLECTION_QCOM, 0) \
    _(XR_OBJECT_TRACKER_DATA_SET_TYPE_OBJECT_QCOM, 1) \
    _(XR_OBJECT_TRACKER_DATA_SET_TYPE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrObjectTrackerDataSetStateQCOM(_) \
    _(XR_OBJECT_TRACKER_DATA_SET_STATE_NONE_QCOM, 0) \
    _(XR_OBJECT_TRACKER_DATA_SET_STATE_LOADING_QCOM, 1) \
    _(XR_OBJECT_TRACKER_DATA_SET_STATE_READY_QCOM, 2) \
    _(XR_OBJECT_TRACKER_DATA_SET_STATE_ERROR_QCOM, 3) \
    _(XR_OBJECT_TRACKER_DATA_SET_STATE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPlaneFilterQCOM(_) \
    _(XR_PLANE_FILTER_HORIZONTAL_UPWARD_QCOM, 1) \
    _(XR_PLANE_FILTER_HORIZONTAL_DOWNWARD_QCOM, 2) \
    _(XR_PLANE_FILTER_HORIZONTAL_QCOM, 3) \
    _(XR_PLANE_FILTER_VERTICAL_QCOM, 4) \
    _(XR_PLANE_FILTER_ARBITRARY_QCOM, 5) \
    _(XR_PLANE_FILTER_ANY_QCOM, 6) \
    _(XR_PLANE_FILTER_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPlaneDetectionStateQCOM(_) \
    _(XR_PLANE_DETECTION_STATE_NONE_QCOM, 0) \
    _(XR_PLANE_DETECTION_STATE_INITIALIZING_QCOM, 1) \
    _(XR_PLANE_DETECTION_STATE_TRACKING_QCOM, 2) \
    _(XR_PLANE_DETECTION_STATE_ERROR_QCOM, 3) \
    _(XR_PLANE_DETECTION_STATE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPlaneTypeQCOM(_) \
    _(XR_PLANE_TYPE_HORIZONTAL_UPWARD_QCOM, 0) \
    _(XR_PLANE_TYPE_HORIZONTAL_DOWNWARD_QCOM, 1) \
    _(XR_PLANE_TYPE_VERTICAL_QCOM, 2) \
    _(XR_PLANE_TYPE_ARBITRARY_QCOM, 3) \
    _(XR_PLANE_TYPE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrTrackingOptimizationSettingsDomainQCOM(_) \
    _(XR_TRACKING_OPTIMIZATION_SETTINGS_DOMAIN_ALL_QCOM, 1) \
    _(XR_TRACKING_OPTIMIZATION_SETTINGS_DOMAIN_IMAGE_TRACKING_QCOM, 1000303000) \
    _(XR_TRACKING_OPTIMIZATION_SETTINGS_DOMAIN_OBJECT_TRACKING_QCOM, 1000304000) \
    _(XR_TRACKING_OPTIMIZATION_SETTINGS_DOMAIN_PLANE_DETECTION_QCOM, 1000305000) \
...
#define XR_LIST_ENUM_XrRayCastTargetTypeQCOM(_) \
    _(XR_RAY_CAST_TARGET_TYPE_PLANE_QCOM, 1000305000) \
    _(XR_RAY_CAST_TARGET_TYPE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrRayTypeQCOM(_) \
    _(XR_RAY_TYPE_STOPPING_QCOM, 0) \
    _(XR_RAY_TYPE_PASSTHROUGH_QCOM, 1) \
    _(XR_RAY_TYPE_MAX_ENUM_QCOM, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrRayCastStateQCOM(_) \
    _(XR_RAY_CAST_STATE_NONE_QCOM, 0) \
    _(XR_RAY_CAST_STATE_CASTING_QCOM, 1) \
    _(XR_RAY_CAST_STATE_FINISHED_QCOM, 2) \
    _(XR_RAY_CAST_STATE_ERROR_QCOM, 3) \
    _(XR_RAY_CAST_STATE_MAX_ENUM_QCOM, 0x7FFFFFFF)
...
#define XR_LIST_BITS_XrObjectTargetBoxBoundFlagsQCOM(_) \
    _(XR_OBJECT_TARGET_BOX_BOUND_EXTENTS_VALID_BIT_QCOM, 0x00000001) \
...
#define XR_LIST_STRUCT_XrSystemImageTrackingPropertiesQCOM(_) \
    _(type) \
    _(next) \
    _(supportsImageTracking) \

#define XR_LIST_STRUCT_XrImageTrackerDataSetBaseHeaderQCOM(_) \
    _(type) \
    _(next) \

#define XR_LIST_STRUCT_XrImageTrackerDataSetCollectionQCOM(_) \
    _(type) \
    _(next) \
    _(buffer) \
    _(bufferSize) \

#define XR_LIST_STRUCT_XrImageTrackerHeightSetCollectionQCOM(_) \
    _(type) \
    _(next) \
    _(names) \
    _(heights) \
...
#define XR_LIST_STRUCT_XrImageTrackerDataSetImageQCOM(_) \
    _(type) \
    _(next) \
    _(name) \
    _(height) \
...
#define XR_LIST_STRUCT_XrImageTrackerCreateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(dataSetCount) \
    _(dataSets) \
...
#define XR_LIST_STRUCT_XrImageTargetsLocateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \

#define XR_LIST_STRUCT_XrImageTargetLocationQCOM(_) \
    _(locationFlags) \
    _(pose) \
    _(imageTarget) \

#define XR_LIST_STRUCT_XrImageTargetVelocityQCOM(_) \
    _(velocityFlags) \
    _(linearVelocity) \
    _(angularVelocity) \
    _(imageTarget) \

#define XR_LIST_STRUCT_XrImageTargetLocationsQCOM(_) \
    _(type) \
    _(next) \
    _(isActive) \
    _(imageCount) \
    _(imageTargetLocations) \

#define XR_LIST_STRUCT_XrImageTargetVelocitiesQCOM(_) \
    _(type) \
    _(next) \
    _(imageCount) \
    _(imageTargetVelocities) \

#define XR_LIST_STRUCT_XrSystemObjectTrackingPropertiesQCOM(_) \
    _(type) \
    _(next) \
    _(supportsObjectTracking) \

#define XR_LIST_STRUCT_XrObjectTrackerDataSetCreateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(dataSetType) \
    _(name) \
...
#define XR_LIST_STRUCT_XrObjectTrackerCreateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(dataSetCount) \
    _(dataSets) \
...
#define XR_LIST_STRUCT_XrObjectTargetsLocateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \

#define XR_LIST_STRUCT_XrObjectTargetLocationQCOM(_) \
    _(locationFlags) \
    _(pose) \
    _(objectTarget) \

#define XR_LIST_STRUCT_XrObjectTargetVelocityQCOM(_) \
    _(velocityFlags) \
    _(linearVelocity) \
    _(angularVelocity) \
    _(objectTarget) \

#define XR_LIST_STRUCT_XrObjectTargetBoxBoundQCOM(_) \
    _(boxBoundFlags) \
    _(extents) \
    _(objectTarget) \

#define XR_LIST_STRUCT_XrObjectTargetLocationsQCOM(_) \
    _(type) \
    _(next) \
    _(isActive) \
    _(objectCount) \
    _(objectTargetLocations) \

#define XR_LIST_STRUCT_XrObjectTargetVelocitiesQCOM(_) \
    _(type) \
    _(next) \
    _(objectCount) \
    _(objectTargetVelocities) \

#define XR_LIST_STRUCT_XrObjectTargetBoxBoundsQCOM(_) \
    _(type) \
    _(next) \
    _(objectCount) \
    _(objectTargetBoxBounds) \

#define XR_LIST_STRUCT_XrObjectTrackerDataSetInfoQCOM(_) \
    _(targetCount) \
    _(targetNameLengths) \
    _(targetNames) \

#define XR_LIST_STRUCT_XrObjectTrackerDataSetsInfoQCOM(_) \
    _(dataSetCount) \
    _(dataSetInfos) \

#define XR_LIST_STRUCT_XrObjectTrackerInfoQCOM(_) \
    _(dataSetsInfo) \

#define XR_LIST_STRUCT_XrSystemPlaneDetectionPropertiesQCOM(_) \
    _(type) \
    _(next) \
    _(supportsPlaneDetection) \

#define XR_LIST_STRUCT_XrPlaneDetectionCreateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(planeFilter) \
    _(enableConvexHull) \

#define XR_LIST_STRUCT_XrPlanesLocateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(baseSpace) \
    _(time) \

#define XR_LIST_STRUCT_XrExtent2DfQCOM(_) \
    _(type) \
    _(next) \
    _(min) \
    _(max) \

#define XR_LIST_STRUCT_XrPlaneExtentQCOM(_) \
    _(type) \
    _(next) \
    _(extentX) \
    _(extentY) \

#define XR_LIST_STRUCT_XrPlaneLocationQCOM(_) \
    _(locationFlags) \
    _(pose) \
    _(id) \
    _(planeType) \
    _(confidence) \
    _(size) \
    _(convexHullBufferId) \

#define XR_LIST_STRUCT_XrPlaneLocationsQCOM(_) \
    _(type) \
    _(next) \
    _(planeCapacityInput) \
    _(planeCountOutput) \
    _(planeLocations) \

#define XR_LIST_STRUCT_XrPlaneConvexHullBufferInfoQCOM(_) \
    _(type) \
    _(next) \
    _(convexHullBufferId) \

#define XR_LIST_STRUCT_XrPlaneConvexHullVertexBufferQCOM(_) \
    _(type) \
    _(next) \
    _(vertexCapacityInput) \
    _(vertexCountOutput) \
...
#define XR_LIST_STRUCT_XrRayCastCreateInfoQCOM(_) \
    _(type) \
    _(next) \
    _(rayType) \
    _(targetTypeCount) \
...
#define XR_LIST_STRUCT_XrRayCollisionsGetInfoQCOM(_) \
    _(type) \
    _(next) \
    _(baseSpace) \

#define XR_LIST_STRUCT_XrRayCollisionQCOM(_) \
    _(type) \
    _(next) \
    _(targetId) \
    _(targetType) \
...
#define XR_LIST_STRUCT_XrRayCollisionsQCOM(_) \
    _(type) \
    _(next) \
    _(collisionCapacityInput) \
    _(collisionCountOutput) \
    _(collisions) \

#define XR_LIST_STRUCT_XrComponentVersionQCOM(_) \
    _(type) \
    _(next) \
    _(componentName) \
    _(versionIdentifier) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrSystemImageTrackingPropertiesQCOM, XR_TYPE_SYSTEM_IMAGE_TRACKING_PROPERTIES_QCOM) \
    _(XrImageTrackerDataSetCollectionQCOM, XR_TYPE_IMAGE_TRACKER_DATA_SET_COLLECTION_QCOM) \
    _(XrImageTrackerHeightSetCollectionQCOM, XR_TYPE_IMAGE_TRACKER_HEIGHT_SET_COLLECTION_QCOM) \
    _(XrImageTrackerDataSetImageQCOM, XR_TYPE_IMAGE_TRACKER_DATA_SET_IMAGE_QCOM) \
    _(XrImageTrackerCreateInfoQCOM, XR_TYPE_IMAGE_TRACKER_CREATE_INFO_QCOM) \
    _(XrImageTargetsLocateInfoQCOM, XR_TYPE_IMAGE_TARGETS_LOCATE_INFO_QCOM) \
    _(XrImageTargetLocationsQCOM, XR_TYPE_IMAGE_TARGET_LOCATIONS_QCOM) \
    _(XrImageTargetVelocitiesQCOM, XR_TYPE_IMAGE_TARGET_VELOCITIES_QCOM) \
    _(XrSystemObjectTrackingPropertiesQCOM, XR_TYPE_SYSTEM_OBJECT_TRACKING_PROPERTIES_QCOM) \
    _(XrObjectTrackerDataSetCreateInfoQCOM, XR_TYPE_OBJECT_TRACKER_DATA_SET_CREATE_INFO_QCOM) \
    _(XrObjectTrackerCreateInfoQCOM, XR_TYPE_OBJECT_TRACKER_CREATE_INFO_QCOM) \
    _(XrObjectTargetsLocateInfoQCOM, XR_TYPE_OBJECT_TARGETS_LOCATE_INFO_QCOM) \
    _(XrObjectTargetLocationsQCOM, XR_TYPE_OBJECT_TARGET_LOCATIONS_QCOM) \
    _(XrObjectTargetVelocitiesQCOM, XR_TYPE_OBJECT_TARGET_VELOCITIES_QCOM) \
    _(XrObjectTargetBoxBoundsQCOM, XR_TYPE_OBJECT_TARGET_BOX_BOUNDS_QCOM) \
    _(XrSystemPlaneDetectionPropertiesQCOM, XR_TYPE_SYSTEM_PLANE_DETECTION_PROPERTIES_QCOM) \
    _(XrPlaneDetectionCreateInfoQCOM, XR_TYPE_PLANE_DETECTION_CREATE_INFO_QCOM) \
    _(XrPlanesLocateInfoQCOM, XR_TYPE_PLANES_LOCATE_INFO_QCOM) \
    _(XrExtent2DfQCOM, XR_TYPE_EXTENT2_DF_QCOM) \
    _(XrPlaneExtentQCOM, XR_TYPE_PLANE_EXTENT_QCOM) \
    _(XrPlaneLocationsQCOM, XR_TYPE_PLANE_LOCATIONS_QCOM) \
    _(XrPlaneConvexHullBufferInfoQCOM, XR_TYPE_PLANE_CONVEX_HULL_BUFFER_INFO_QCOM) \
    _(XrPlaneConvexHullVertexBufferQCOM, XR_TYPE_PLANE_CONVEX_HULL_VERTEX_BUFFER_QCOM) \
    _(XrRayCastCreateInfoQCOM, XR_TYPE_RAY_CAST_CREATE_INFO_QCOM) \
    _(XrRayCollisionsGetInfoQCOM, XR_TYPE_RAY_COLLISIONS_GET_INFO_QCOM) \
    _(XrRayCollisionQCOM, XR_TYPE_RAY_COLLISION_QCOM) \
    _(XrRayCollisionsQCOM, XR_TYPE_RAY_COLLISIONS_QCOM) \
    _(XrComponentVersionQCOM, XR_TYPE_COMPONENT_VERSION_QCOM) \
...
#define XR_LIST_EXTENSIONS(_) \
    ...
    _(XR_EXT_uuid, 300) \
    _(XR_QCOM_image_tracking, 304) \
    _(XR_QCOM_object_tracking, 305) \
    _(XR_QCOM_plane_detection, 306) \
    _(XR_QCOM_tracking_optimization_settings, 307) \
    _(XR_QCOM_ray_casting, 308) \
    _(XR_QCOM_component_versioning, 309) \
